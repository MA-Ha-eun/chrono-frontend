...
export const mockMessages: MessageListItem[] = [
  {
    ...
    content: "새로 만든 대시보드 시안 한 번 봐줄 수 있을까요?",
    read: false,
  ...
  },
  {
    ...
    receiverId: mockUser.userId!,
    receiverNickname: mockUser.nickname,
    content: "오늘 배포 일정 오후 3시로 옮겼습니다. 참고 부탁드려요.",
    read: true,
  ...
  },
  {
    ...
    receiverId: 4,
    receiverNickname: "프론트엔드",
    content: "프로젝트 상세 페이지 반응형 이슈 내일까지 같이 볼 수 있을까요?",
    read: true,
  ...
  },
  {
    ...
    senderNickname: mockUser.nickname,
    receiverId: 2,
    receiverNickname: "디자이너",
    content:
      "상단 Navbar 아이콘 정리한 버전 푸시했습니다. 한 번 체크해 주세요.",
    read: false,
    createdAt: getDateTimeString(0, 4),
  },
];
